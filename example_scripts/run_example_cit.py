...
DEBUG = True
'''actual estimation'''
graphs, stats_list = digraph_hyp_test(adj_m=adj_m_cit, var_dict = var_dict_citation, test_variable= ('paper','B','A'), controlls=['timelayer','random'],  anz_sim=1000, show_plot=True)

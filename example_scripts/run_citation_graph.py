...
'''actual estimation'''
graphs, stats_list = digraph_hyp_test(adj_m=adj_m, var_dict = var_dict, test_variable= ('journal','econometric theory','econometric review'), controls=['timelayer', 'journal'], anz_sim=50, show_plot=True)
